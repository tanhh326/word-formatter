...
public class IllustrationScheduleChecklistFormatter extends AbstractFormatter {

  private final StyleConfigDto styleConfigDto = formattingProcessShareVar.getStyleConfig(
      sectionEnums());


  public IllustrationScheduleChecklistFormatter(
  ...
  public void formatTitle() {
    if (titles.isEmpty()) {
      ...
      title.getRuns().add(new Run(studetDocument, "插图和附表清单"));
      titles.add(title);
    }
