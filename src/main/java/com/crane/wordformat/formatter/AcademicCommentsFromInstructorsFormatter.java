...
public class AcademicCommentsFromInstructorsFormatter extends AbstractFormatter {
  ...
  public AcademicCommentsFromInstructorsFormatter(
  ...
  public void formatTitle() {
    if (titles.isEmpty()) {
      ...
      title.getRuns().add(new Run(studetDocument, "指导教师学术评语"));
      titles.add(title);
    }
